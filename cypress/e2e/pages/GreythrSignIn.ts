...
//     this.elements.email_input().type('') // Enter your email
//     // this.elements.email_continue().click()
//     this.elements.password_input().type('') // Enter your password
//     this.elements.login().click()
//     cy.wait(3000)
//     cy.contains('Sign In', { includeShadowDom: true }).click()
//   }
// }

// // ✅ Correct default export
// export default new GreythrIn()
